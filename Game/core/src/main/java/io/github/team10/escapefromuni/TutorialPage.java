...
public class TutorialPage implements Screen {
  ...
  public void display() {
    ...
    game.batch.begin();
    game.batch.draw(tutorialImage, 0, 0, 
  ...
  /**
   * Runs every frame and displays the tutorial page.
   * 
   * @param delta - the number of seconds between a frame
   */
  @Override
  ...
  /** 
   * Frees memory space when it is no longer needed.
   */
  @Override
  public void dispose() {
