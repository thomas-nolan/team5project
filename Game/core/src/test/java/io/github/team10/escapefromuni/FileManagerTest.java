...
public class FileManagerTest {
  ...
  /**
   * Tests that reading a scores file returns a map containing the correct player names and scores.
   * 
  ...
  /**
   * Tests that when trying to write more than five entries.
   * Only a maximum of five are actually written.
   * 
   * @param tempDir Temporary directory used by JUnit
   * @throws IOException If can't access the file
   */
  ...
  void writeFile_WritesMaximumOfFive(@TempDir Path tempDir) throws IOException {
    final Path file = tempDir.resolve("scores.csv");
